\casesection{Coriolis in a basin with bottom friction}
\label{case:corioliswithfriction}
...
\paragraph*{Results}
The results for each of the three grids are shown in \Fref{fig:kelvinfricyes} in comparison with the semi-analytical solution. Maximum surface elevations are shown.
